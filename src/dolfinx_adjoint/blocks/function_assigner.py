...
class FunctionAssignBlock(Block):
    ...
    def recompute_component(self, inputs, block_variable, idx, prepared):
        ...
        if isinstance(output, _Function) and not output._ad_bc_backing:
        ...
        # Otherwise (a Function tagged _ad_bc_backing) return the exact object instance to
        # maintain C++ memory bindings, updating it in-place.
